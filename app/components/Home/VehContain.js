...
import { VehUserIdContext } from "../../context/VehUserIdContext"; // Importa el contexto del usuario

const VehContain = () => {
  const { userId } = useContext(VehUserIdContext); // Obtiene el userId del usuario autenticado desde el contexto
